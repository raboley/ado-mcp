...
def calculate_next_version(
    package_name: str, target_major: int, target_minor: int
) -> str:
    """
    ...
    if target_major > current_major or (target_major == current_major and target_minor > current_minor):
        ...
        print(f"Warning: Target version {target_major}.{target_minor} is older than current {current_major}.{current_minor}", file=sys.stderr)
        next_patch = 1
