...
def fix_file_imports(file_path):
    ...
    content = re.sub(r'get_project_name, get_.*_pipeline_id[^,]*(?:, )?', 'get_project_name', content)
    ...
    content = re.sub(r'^async def get_pipeline_id_by_name.*?^$', '', content, flags=re.MULTILINE | re.DOTALL)
