...
async def test_cache_hit_miss_telemetry(mcp_client, project_id):
    ...
    with patch.object(ado_cache._cache_hit_counter, 'add') as mock_hit_counter, \
        ...
        mock_miss_counter.assert_called_with(1, {"cache_type": "work_item_types", "reason": "not_found"})
...
async def test_cache_eviction_telemetry():
    ...
    with patch.object(ado_cache._cache_eviction_counter, 'add') as mock_eviction_counter, \
        ...
        mock_eviction_counter.assert_called_with(1, {"cache_type": "test_type", "reason": "expired"})
