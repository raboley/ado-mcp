...
from ado.errors import AdoRateLimitError, AdoNetworkError, AdoTimeoutError, AdoAuthenticationError, AdoError
...
class TestWorkItemErrorHandlingSimplified:
    ...
    def test_structured_error_exception_hierarchy(self, work_items_client):
        ...
        error_classes = [AdoRateLimitError, AdoNetworkError, AdoTimeoutError, AdoAuthenticationError]
        ...
        for error_class in error_classes:
            ...
            # Verify inheritance
            assert isinstance(error, AdoError), f"{error_class.__name__} should inherit from AdoError"
