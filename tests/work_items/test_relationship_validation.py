...
class TestRelationshipTypeValidation:
    ...
    def test_validate_relationship_type_valid_types(self):
        ...
        for rel_type in valid_types:
            assert WorkItemValidator.validate_relationship_type(rel_type), f"{rel_type} should be valid"

    def test_validate_relationship_type_invalid_types(self):
        """Test validation of invalid relationship types."""
        invalid_types = [
            "Invalid.Type",
            "System.LinkTypes.NonExistent",
            "Random.String",
            "",
            None
        ]
        ...
        for rel_type in invalid_types:
            assert not WorkItemValidator.validate_relationship_type(rel_type), f"{rel_type} should be invalid"
...
class TestRelationshipConstraintValidation:
    ...
    def test_validate_hierarchy_forward_valid(self):
        ...
        for source_type, target_type, rel_type in valid_cases:
            ...
            assert is_valid, f"Should allow {source_type} -> {target_type} hierarchy relationship but got error: {error}"
    ...
    def test_validate_hierarchy_forward_invalid(self):
        ...
        for source_type, target_type, rel_type in invalid_cases:
            ...
            assert not is_valid, f"Should reject {source_type} -> {target_type} hierarchy relationship"
    ...
    def test_validate_dependency_relationships(self):
        ...
        for source_type in valid_dependency_types:
            for target_type in valid_dependency_types:
                ...
                assert is_valid, f"Should allow dependency {source_type} -> {target_type} but got error: {error}"
    ...
    def test_validate_duplicate_relationships(self):
        ...
        for work_type in work_item_types:
            ...
            assert is_valid, f"Should allow duplicate relationship for same type {work_type} but got error: {error}"
        ...
        for source_type, target_type, rel_type in invalid_cases:
            ...
            assert not is_valid, f"Should reject duplicate relationship between different types {source_type} -> {target_type}"
    ...
    def test_validate_test_relationships(self):
        ...
        for source_type, target_type, rel_type in valid_cases:
            ...
            assert is_valid, f"Should allow test relationship {source_type} -> {target_type} but got error: {error}"
        ...
        for source_type, target_type, rel_type in invalid_cases:
            ...
            assert not is_valid, f"Should reject invalid test relationship {source_type} -> {target_type}"
    ...
    def test_validate_related_relationships_always_valid(self):
        ...
        for source_type in work_item_types:
            for target_type in work_item_types:
                ...
                assert is_valid, f"Related relationships should always be valid: {source_type} -> {target_type}"
