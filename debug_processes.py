...
async def debug_processes():
    ...
    async with Client(mcp) as client:
        ...
        process_info = await client.call_tool("get_project_process_info", {"project_id": project_id})
        ...
        try:
            process_details = await client.call_tool("get_process_details", {"process_id": process_id.data})
