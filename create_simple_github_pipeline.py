#!/usr/bin/env python3
"""
Create a simple GitHub resources pipeline
"""
import asyncio
...
async def create_simple_github_pipeline():
    ...
    async with Client(mcp) as client:
        ...
        # Create the pipeline
        print("Creating simple GitHub resources pipeline...")
        pipeline_name = "github-resources-simple"
        yaml_path = "tests/ado/fixtures/github-resources-simple.yml"
