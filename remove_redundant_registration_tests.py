...
tests_to_remove = [
    ...
    (
        ...
        "test_check_authentication_tool_registration",
    ),
    # Project Management
    ...
    (
        ...
        "test_run_pipeline_by_name_tool_registration",
    ),
    (
        "tests/pipeline_runs/test_run_pipeline_with_parameters.py",
        "test_run_pipeline_parameter_combinations_tool_registration",
    ),
    ...
    (
        ...
        "test_get_pipeline_failure_summary_tool_registration",
    ),
    # Service Connections
    (
        "tests/service_connections/test_list_service_connections.py",
        "test_list_service_connections_tool_registration",
    ),
    # Work Item CRUD
    ...
    (
        ...
        "test_list_work_items_tool_registered_in_mcp_server",
    ),
    ...
    (
        ...
        "test_get_recent_work_items_tool_registration",
    ),
    ...
    (
        ...
        "test_enhanced_type_tools_registered_in_mcp_server",
    ),
